...
{
    public class GeneralInfoRequestProcessor : IRequestProcessor
    {
        ...
        public GeneralInfoRequestProcessor(string asiNumber)
        {
        ...
        public StoredProcedureRequest CreateRequest()
        {
            ...
            {
                StoredProcedureName = "USR_CPI_General_Select",
                IsUDFScalar = true,
